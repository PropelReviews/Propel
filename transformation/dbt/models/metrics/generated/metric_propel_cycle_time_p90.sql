...
-- metric_id: propel.cycle_time_p90
-- definition_version: b882134579e0
-- source: cycle_time_p90.yaml
...
select
    filtered.tenant_id,
    'propel.cycle_time_p90'::text as metric_id,
    'b882134579e0'::text as definition_version,
    'day'::text as grain,
